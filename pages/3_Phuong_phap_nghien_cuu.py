...
st.markdown('<div class="sub-section-title">Bảng tổng hợp đối chiếu kết quả PCA: Trường học vs Y tế</div>', unsafe_allow_html=True)
    st.markdown('<div class="academic-paragraph">Bảng dưới đây tổng hợp và đối chiếu các thành phần chính (PC) được lựa chọn để tính toán trọng số cho Chỉ số FVI. Các thành phần bị loại bỏ (PC3 của Exposure/Sensitivity và PC4 của Adaptivity) không được hiển thị để tối ưu hóa không gian trực quan.</div>', unsafe_allow_html=True)

    # Khởi tạo bảng dữ liệu gộp tinh gọn, đối chiếu trực diện
    pca_compact_df = pd.DataFrame([
        # --- EXPOSURE ---
        {
            "Hợp phần FVI": "Exposure (Phơi nhiễm)",
            "Thành phần": "PC1",
            "Trường học: Phương sai & Biến chi phối": "57.36% | Ngập tại chỗ (flood_val: 0.96)",
            "Y tế: Phương sai & Biến chi phối": "60.48% | Ngập lân cận 200m (flood_val_200m: 0.67)"
        },
        {
            "Hợp phần FVI": "Exposure (Phơi nhiễm)",
            "Thành phần": "PC2",
            "Trường học: Phương sai & Biến chi phối": "24.24% | Ngập lân cận 200m (flood_val_200m: 0.96)",
            "Y tế: Phương sai & Biến chi phối": "27.33% | Cách sông chính (dist_to_river: 0.83)"
        },
        {
            "Hợp phần FVI": "TỔNG EXPOSURE GIỮ LẠI",
            "Thành phần": "PC1 + PC2",
            "Trường học: Phương sai & Biến chi phối": "81.60% (Đủ cơ sở toán học)",
            "Y tế: Phương sai & Biến chi phối": "87.80% (Giải thích phần lớn dữ liệu)"
        },
        
        # --- SENSITIVITY ---
        {
            "Hợp phần FVI": "Sensitivity (Độ nhạy)",
            "Thành phần": "PC1",
            "Trường học: Phương sai & Biến chi phối": "51.20% | Vai trò điểm sơ tán (Shelter: 0.94)",
            "Y tế: Phương sai & Biến chi phối": "37.50% | Điểm cứu trợ & Quy mô bệnh nhân (0.66)"
        },
        {
            "Hợp phần FVI": "Sensitivity (Độ nhạy)",
            "Thành phần": "PC2",
            "Trường học: Phương sai & Biến chi phối": "24.40% | Quy mô nhân sự & Học sinh (Staff/Client)",
            "Y tế: Phương sai & Biến chi phối": "28.67% | Tuổi thọ công trình (YearOfBuilding: 0.84)"
        },
        {
            "Hợp phần FVI": "TỔNG SENSITIVITY GIỮ LẠI",
            "Thành phần": "PC1 + PC2",
            "Trường học: Phương sai & Biến chi phối": "75.60% (Tập trung vào áp lực nhân sinh)",
            "Y tế: Phương sai & Biến chi phối": "66.17% (Kết hợp hạ tầng và tải bệnh nhân)"
        },
        
        # --- ADAPTIVITY ---
        {
            "Hợp phần FVI": "Adaptivity (Thích ứng)",
            "Thành phần": "PC1",
            "Trường học: Phương sai & Biến chi phối": "53.91% | Phương tiện đường thủy (Boat: 0.99)",
            "Y tế: Phương sai & Biến chi phối": "53.91% | Phương tiện đường thủy (Boat: 0.99)"
        },
        {
            "Hợp phần FVI": "Adaptivity (Thích ứng)",
            "Thành phần": "PC2",
            "Trường học: Phương sai & Biến chi phối": "16.76% | Kế hoạch & Diễn tập (planning: 0.83)",
            "Y tế: Phương sai & Biến chi phối": "16.76% | Kế hoạch & Lập phương án y tế (0.83)"
        },
        {
            "Hợp phần FVI": "Adaptivity (Thích ứng)",
            "Thành phần": "PC3",
            "Trường học: Phương sai & Biến chi phối": "12.73% | Hạ tầng kỹ thuật (infra_mag_score: 0.73)",
            "Y tế: Phương sai & Biến chi phối": "12.73% | Nguồn điện/nước dự phòng độc lập (0.73)"
        },
        {
            "Hợp phần FVI": "TỔNG ADAPTIVITY GIỮ LẠI",
            "Thành phần": "PC1 + PC2 + PC3",
            "Trường học: Phương sai & Biến chi phối": "83.40% (Đầy đủ cấu phần cứng/mềm)",
            "Y tế: Phương sai & Biến chi phối": "83.40% (Đảm bảo duy trì chuỗi y tế khẩn cấp)"
        }
    ])
    
    # Hiển thị bảng gộp tinh gọn
    st.table(pca_compact_df)
    
    st.markdown('<div class="sub-section-title">Luận cứ khoa học từ kết quả đối chiếu</div>', unsafe_allow_html=True)
    st.markdown("""
        <ul class="academic-list">
            <li><b>Sự khác biệt về Độ phơi nhiễm (Exposure):</b> Hệ thống <b>Trường học</b> bị chi phối mạnh nhất bởi mức độ ngập lụt tại chỗ (PC1: 57.36%), tức là khả năng chống chịu của bản thân khuôn viên trường. Ngược lại, hệ thống <b>Y tế</b> lại bị chi phối trước tiên bởi mức độ ngập đường lân cận trong bán kính 200m (PC1: 60.48%). Điều này phản ánh thực tế: trạm y tế chỉ vận hành hiệu quả khi lưới giao thông tiếp cận không bị cô lập, đảm bảo xe cứu thương di chuyển liên tục.</li>
            <li><b>Sự khác biệt về Độ nhạy cảm (Sensitivity):</b> Điểm tương đồng lớn nhất là cả hai ngành đều chịu áp lực nặng nề nếu cơ sở đó được chỉ định làm điểm sơ tán/cứu trợ lũ cho cộng đồng (lọt vào PC1 của cả hai ngành). Tuy nhiên, yếu tố tạo sự khác biệt ở PC2 của trường học là quy mô con người (học sinh/nhân sự), còn ở trạm y tế lại là độ bền vững, tuổi thọ của công trình xây dựng (0.84).</li>
            <li><b>Sự đồng nhất về Năng lực thích ứng (Adaptive Capacity):</b> Cấu trúc dữ liệu của cả hai ngành phản xạ hoàn toàn đồng điệu (giữ lại 3 PC đầu, đạt 83.40% phương sai). Trọng số ưu tiên cao nhất tập trung vào phần cứng di chuyển khẩn cấp (<i>Boat</i>: 0.99), tiếp theo là phần mềm quản lý (<i>planning</i>: 0.83) và cuối cùng là năng lực độc lập năng lượng phụ trợ (<i>infrastructure_mag_score</i>: 0.73) nhằm sống sót khi đô thị mất điện.</li>
        </ul>
    """, unsafe_allow_html=True)
